...
import { motion, MotionProps, useTransform, useScroll } from "framer-motion";
        ...
        <section className="section section2" ref={ref}>
            <div className="skillList">
                <motion.div className="motion" ref={carouselRef} style={{ x }}>
                    ...
                    <motion.div {...slideAnimation} className="icon react">
                        <FontAwesomeIcon icon={faReact} style={{color: "#61dafb",}} />
                    </motion.div>
                    <motion.div {...slideAnimation} className="icon github">
                        <FontAwesomeIcon icon={faGithub} style={{color: "#6879d9",}} />
                    </motion.div>
                </motion.div>
            </div>
        </section>
